        ...
        <div className="border-t border-gray-100 mt-auto">
          <div className="border-b border-gray-100">
            ...
            >
              ...
              <span
                className="text-xl font-extralight transition-transform duration-300"
                style={{
                  transform: descOpen ? "rotate(0deg)" : "rotate(45deg)",
                }}
              >
                {descOpen ? "—" : "+"}
              </span>
      ...
      <div className="order-1 lg:order-2 flex-1 bg-[#F9F9F9] relative flex items-center justify-center overflow-hidden h-[70vh] lg:h-screen p-8 lg:p-20">
        ...
        >
          <div className="relative w-full h-full">
            <Image
              src={
                activeProduct.images.thumbnails[activeThumb] ||
      ...
      <div className="order-3 flex flex-col w-full lg:w-[35%] xl:w-[28%] p-8 lg:p-16 bg-white justify-center border-l border-gray-50">
        <div className="max-w-sm mx-auto lg:ml-0 w-full">
          ...
          <div className="space-y-16">
            <div>
              <p className="text-[14px] uppercase tracking-[0.4em] font-bold mb-6 text-gray-900">
                Palettes
              </p>
            ...
            <div>
              <div className="flex justify-between items-center mb-6">
                <p className="text-[14px] uppercase tracking-[0.4em] font-bold text-gray-900">
                  Dimensions
                </p>
                <button className="text-[11px] uppercase tracking-[0.3em] text-gray-700 hover:text-black transition-colors border-b border-transparent hover:border-black">
                  Sizing Guide
                </button>
              </div>
          ...
          <div className="mt-20 space-y-4">
            <button className="group relative w-full overflow-hidden border-2 border-black bg-black py-7 text-[14px] font-black uppercase tracking-[0.4em] text-white transition-colors duration-500 shadow-lg">
            ...
            <button className="group relative w-full overflow-hidden border-2 border-zinc-200 bg-white py-7 text-[12px] font-black uppercase tracking-[0.4em] text-black transition-colors duration-500">
