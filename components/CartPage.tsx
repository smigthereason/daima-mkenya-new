...
export default function CartPage() {
  ...
  const router = useRouter();
  const { cartItems, removeFromCart, updateQuantity, loading, isInitialized } =
    useCart();
  ...
  if (status === "loading" || !isInitialized) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-white mt-24">
                  ...
                  <div className="md:col-span-3 flex flex-col justify-between py-2">
                    <div className="flex justify-between items-start">
                      ...
                      <button
                        onClick={() => removeFromCart(item.cartId)}
                        disabled={loading}
                        className="text-gray-300 hover:text-[#be1e2d] transition-colors p-2 cursor-pointer disabled:opacity-50"
                      >
                        <Trash2 size={20} />
                      </button>
                    </div>
                    ...
                    <div className="flex justify-between items-end mt-12 md:mt-0">
                      <div className="flex items-center border border-neutral-200">
                        <button
                          ...
                          className="p-4 hover:bg-neutral-50 transition-colors cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                          <Minus size={14} />
                        </button>
                        ...
                        <button
                          ...
                          disabled={loading}
                          className="p-4 hover:bg-neutral-50 transition-colors cursor-pointer disabled:opacity-50"
                        >
                          <Plus size={14} />
                        </button>
                      </div>
