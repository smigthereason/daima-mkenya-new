...
//   // Robust calculation to handle "blank" or NaN quantities during lag
//   const total = useMemo(() => {
//     return cartItems.reduce((acc, item) => {
//       if (!item.product?.price) return acc;
//       const unitPrice = parseFloat(item.product.price.replace(/[^0-9.]/g, ""));
//       const qty = Number(item.quantity) || 0; // Fallback to 0 if blank
//       return acc + (isNaN(unitPrice) ? 0 : unitPrice * qty);
//     }, 0);
//   }, [cartItems]);
