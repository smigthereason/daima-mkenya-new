...
const Navbar = () => {
   ...
   const navLinks = [
      ...
      // { name: 'Winter Collection', badge: 'NEW' },
         ...
         <div className="grid grid-cols-3 items-center w-full">
            ...
            <div className="flex justify-start">
               ...
               >
                  ...
                  <span className="hidden md:block text-[11px] uppercase tracking-[0.2em] font-medium pt-0.5">Menu</span>
               </button>
            </div>
                  ...
                  <div className="flex flex-col gap-4">
                     {navLinks.map((link, index) => (
                        <Link
                           ...
                           href="#"
                           onClick={() => setIsOpen(false)}
                           className={`group flex items-center justify-between text-4xl md:text-7xl font-light text-black transition-all duration-700 ${isOpen ? 'translate-x-0 opacity-100' : '-translate-x-20 opacity-0'
                              }`}
