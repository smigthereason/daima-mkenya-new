...
import { Instagram, Twitter, Facebook, Youtube, Linkedin, ArrowRight } from 'lucide-react';
...
const Footer = () => {
   return (
      <footer className=" text-white p-6 md:p-12 min-h-screen flex ">
         <div className=" bg-neutral-900 w-full grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch border border-zinc-800 rounded-[40px] overflow-hidden p-4 md:p-8">
               ...
               <div className="space-y-12">
                  <div className="flex flex-col md:flex-row md:items-end gap-8">
                     ...
                     <div className="flex-1 max-w-sm">
                        <input
                           ...
                           className="w-full bg-transparent border-b border-zinc-700 pb-2 mb-4 focus:outline-none focus:border-white transition-colors"
                        />
                        <button className="bg-zinc-900 border border-zinc-800 hover:bg-zinc-800 text-white px-8 py-2 rounded-full text-sm transition-all">
                           Subscribe
                        </button>
                     </div>
                  </div>
                  ...
                  <div className="flex space-x-4">
                     {[Instagram, FaXTwitter, Facebook].map((Icon, idx) => (
                        <a key={idx} href="#" className="p-2 bg-white rounded-full text-black hover:bg-zinc-200 transition-colors">
            ...
            <div className="relative group overflow-hidden rounded-4xl hidden md:flex">
               <Image
                  src={HeroImage2}
               ...
               <div className="absolute bottom-8 right-8">
                  <button className="bg-white text-black p-6 rounded-2xl flex flex-col items-start gap-4 hover:bg-zinc-100 transition-all w-48 shadow-2xl">
