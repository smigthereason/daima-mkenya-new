...
//   return (
//     <div className="min-h-screen bg-white text-black antialiased mt-24 md:mt-32 border-t border-neutral-200">
//       {/* ── TOP NAVIGATION ── */}
//       <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md flex justify-between items-center px-4 md:px-16 py-4 md:py-6 border-b border-gray-100">
//         <button
//           onClick={onBack}
...
//       {/* Changed max-w-450 back to your original layout but removed overflow-hidden */}
//       <div className="max-w-[1800px] mx-auto w-full">
//         <div className="flex flex-col lg:flex-row">
          
//           {/* ── DESIGN: ORDER SUMMARY (Left Column - Now Scrolls Naturally) ── */}
...
//           {/* ── DESIGN: CHECKOUT FORM (Right Column - Fixed/Sticky) ── */}
//           <div className="w-full lg:w-[60%] p-6 md:p-12 lg:p-20 bg-white">
//             {/* Added sticky container here */}
...
//                       <label className="text-[8px] md:text-[9px] uppercase tracking-widest font-bold text-gray-400">Full Name</label>
//                       <input 
//                         required 
//                         type="text" 
//                         defaultValue={session?.user?.name || ""}
//                         className="border-b border-gray-200 py-2 focus:border-black outline-none transition-colors text-sm" 
//                       />
//                     </div>
//                     <div className="flex flex-col gap-2">
...
//                       <label className="text-[8px] md:text-[9px] uppercase tracking-widest font-bold text-gray-400">Shipping Address</label>
...
export default function CheckOutPage({ onBack }: CheckOutPageProps) {
  ...
  /**
   * UPDATED: handleCompletePurchase
   * This now calls your internal Next.js API to register the order with PesaPal.
   */
    ...
    try {
      const response = await fetch("/api/pesapal/register-order", {
        ...
        body: JSON.stringify({
          ...
          // You can also pass cartItems if your API needs to save them to Sanity
        }),
      });
      ...
      if (data.redirect_url) {
        ...
        // Handle API errors (e.g., invalid keys, IPN not registered)
        alert(`Error: ${data.message || "Could not initiate payment. Please check your IPN registration in the PesaPal dashboard."}`);
        setIsProcessing(false);
      }
    } catch (error) {
    ...
    <div className="min-h-screen bg-white text-black antialiased mt-24 md:mt-32 border-t border-neutral-200">
      ...
      <div className="max-w-[1800px] mx-auto w-full">
        <div className="flex flex-col lg:flex-row">
          ...
          {/* ── DESIGN: ORDER SUMMARY (Left Column) ── */}
          <div className="w-full lg:w-[40%] p-6 md:p-12 lg:p-20 bg-[#F9F9F9] border-b lg:border-b-0 lg:border-r border-gray-100">
            <span className="text-[10px] uppercase tracking-[0.5em] text-gray-400 block mb-6 md:mb-8 font-bold">
              01. Review Order
            </span>
          ...
          {/* ── DESIGN: CHECKOUT FORM (Right Column) ── */}
          <div className="w-full lg:w-[60%] p-6 md:p-12 lg:p-20 bg-white">
            <div className="lg:sticky lg:top-40">
              <form onSubmit={handleCompletePurchase} className="max-w-xl mx-auto lg:ml-0 space-y-12 md:space-y-16">
