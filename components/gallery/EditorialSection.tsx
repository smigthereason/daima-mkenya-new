...
const EditorialSection = () => (
  <section className="mt-24 md:mt-40 border-t border-neutral-200 pt-16 md:pt-24 max-w-[1800px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
    {/* Portrait orientation container: Adjusted height classes for taller aspect ratio */}
    <div className="lg:col-span-5 relative h-[500px] sm:h-[600px] lg:h-[750px] w-full group overflow-hidden shadow-xl">
      <Image
        src="/assets/Gallery/Editorial_sect.jpg"
        alt="Daima Mkenya Studio session 2026 - Kenyan Heritage Fashion Editorial Nairobi"
        fill
        priority
        quality={90} // Added high quality for portrait display
      ...
      <div className="absolute bottom-6 left-6 md:bottom-10 md:left-10 text-white z-10">
        <div className="bg-gradient-to-r from-black/70 to-transparent p-3 rounded">
          <p className="text-[9px] md:text-[10px] uppercase tracking-[0.5em] font-bold">
            Studio Session
          </p>
          <h5 className="text-xl md:text-2xl font-light italic">
            Daima Mkenya 2026
          </h5>
        </div>
      </div>
    ...
    <div className="lg:col-span-7">
      <h4 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-light tracking-tighter mb-8 md:mb-10 leading-[0.9] md:leading-[0.85]">
        STAY ROOTED. <br />
        STAY{" "}
        <span className="text-[#be1e2d] font-medium italic">AUTHENTIC.</span>
      </h4>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 md:gap-12 border-l border-neutral-200 pl-6 md:pl-10">
        <address className="not-italic flex flex-col gap-2 md:gap-3">
          <span className="text-[9px] md:text-[10px] uppercase tracking-[0.3em] font-bold text-neutral-400">
            Instagram
          </span>
          <a
            href="https://instagram.com/daimastudio"
            className="text-xs md:text-sm font-medium hover:text-[#be1e2d] uppercase tracking-widest"
          >
            @daimastudio
          </a>
        </address>
